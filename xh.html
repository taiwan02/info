    ...
    <div id="page-wrapper">
		...
		<img id="qrcode" height="170em" src="./ok.svg" />
		    ...
		    <li><a id="GetQrCode"  class="button" onclick="GetQrCode()" title="注意事项">注意事项</a>
                    ...
                    <li><a id="login" class="button special" title="QQ群" target="_blank" href="https://jq.qq.com/?_wv=1027&k=r3b2IC7n">QQ群</a>
                    </li>
                </ul>
                <p>
                    <!--<a href="http://www.highdimen.com" target="_blank" style="color:yellow;font-weight:bold">[备用扫码]</a>-->
                    <!--<a href="https://jq.qq.com/?_wv=1027&k=r3b2IC7n" target="_blank" style="color:red;font-weight:bold"> [QQ群]</a><br>-->
                    <!--<a style="color:#00effb;font-weight:bold"> [全自动运行]</a>-->
                    <br /> <a style="font-size:12px;"> App确认后即可（无视升级提示）</a>
					<br /> <a style="font-size:12px;">扫码添加一次即可，请勿重复添加</a>
					<br /> <a style="font-size:12px;">如果觉得可以，请推送个亲朋好友一起使用</a>
                </p>
